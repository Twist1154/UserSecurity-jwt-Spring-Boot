...
import za.ac.eyetv.usersercurity.model.dto.*;   
import za.ac.eyetv.usersercurity.service.AuthenticationService;
import za.ac.eyetv.usersercurity.service.LogoutService;
...
public class AuthenticationController {
    ...
    @PostMapping("/logout")
    // Change signature to accept LogoutRequest in the body
    public ResponseEntity<LogoutResponse> logout(@Valid @RequestBody LogoutRequest logoutRequest) {
        log.info("Logging out user with provided token");
